...
import com.movit.rwe.modules.sys.security.FormAuthenticationFilter;
...
//		try {
//			byte[] bytes = com.movit.rwe.common.utils.FileUtils.readFileToByteArray(
//					com.movit.rwe.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
