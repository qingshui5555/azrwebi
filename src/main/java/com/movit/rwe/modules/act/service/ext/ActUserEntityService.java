 ...
 */
package com.movit.rwe.modules.act.service.ext;
...
import com.movit.rwe.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.movit.rwe.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.movit.rwe.modules.sys.entity.User(null, userId)))){
