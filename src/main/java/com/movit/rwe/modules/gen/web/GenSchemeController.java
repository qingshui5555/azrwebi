 ...
 */
package com.movit.rwe.modules.gen.web;
...
import com.movit.rwe.modules.gen.service.GenSchemeService;
import com.movit.rwe.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.movit.rwe.modules");
		}
