					...
					<table class="table table-striped table-bordered table-hover">
						<tbody>
							...
							<tr>
								<td>P.Value</td>
								<td>
									<label>${fnbi:keepTwoDecimal(rResult.resultMap.pValue)}</label>
								</td>
							</tr>
							<tr>
								<td>Estimate</td>
								<td>
									<label>${fnbi:keepTwoDecimal(rResult.resultMap.estimate)}</label>
								</td>
							</tr>
						</tbody>
					</table>
...
<%--
<c:forEach items="${rResult.resultMap.dataList }" var="obj">
