					...
					<table class="table table-striped table-bordered table-hover">
						<tbody>
							...
							<tr>
								...
								<td>
									<table frame="below" border="0">
										...
										<c:forEach items="${rResult.resultMap.centers}" var="item" varStatus="itemSta">
											<tr>
											<td>${rResult.resultMap.rowNameArray[itemSta.index] }</td>
											<c:forEach items="${item}" var="data">
												<td>${fnbi:keepTwoDecimal(data+0.0000000001)}</td>
											</c:forEach>
											</tr>
										</c:forEach>
									</table>
							...
							<tr>
								<td class="">Classes</td>
								<td>
									<c:forEach items="${fnbi:arrayGroup(rResult.resultMap.cluster)}" var="att"  varStatus="sta">
									<div class="row">
										<div class="col-xs-2">
											${att.key }
										</div>
