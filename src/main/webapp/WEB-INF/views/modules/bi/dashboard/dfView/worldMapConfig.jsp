...
<form id="configForm">
	...
	<table id="indicator" class="table table-striped table-bordered table-hover">
		...
		<tbody>
			<c:forEach items="${worldMapConfigList}" var="config" varStatus="status">
				<tr>
...
<script type="text/javascript">
	...
	function submitConfig() {
		...
		for ( var i in indicatorArr) {
			...
			var worldMapData = {};
            worldMapData["order"] = order;
            worldMapData["id"] = idArr[0] + '_' + order;
            worldMapData["subject"] = type;
            worldMapData["indicator"] = indicator;
            worldMapData["description"] = description;
            worldMapData["resultUnit"] = resultUnit;
            worldMapData["lowerRef"] = lowerRef;
            worldMapData["upperRef"] = upperRef;
			arr.push(worldMapData);

		}

	    lab["worldMapConfigList"] = arr;
