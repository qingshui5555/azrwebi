				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter blue">Create Tab</h3>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-12">
									<form action="${ctxbi}/sys/studyManagment/createTab" method="post" id="createTabForm">
										<table class="whiteTable">
											<input type="hidden" name="dashboardId" value="${dashboardId }">
											<tr>
												<th><spring:message code="tab.input.name"/></th>
												<td><input type="text" name="tabName" id="tabName" style="width: 100px"></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="number" value="${maxSort }" name="sort" id="sort" style="width: 100px" ></td>
											</tr>
											<tr>
												<th></th>
												<td>
													<button type="submit" class="btn btn-purple btn-sm">
														<spring:message code="tab.save"/></button>
